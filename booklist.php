...
<div class="container">
    ...
    <thead>
	  ...
	  <tr>
        <th>
          ...
          <option selected disabled>Publisher/Publication Name</option>
		...
		<th>
			<a href="issuebook.php"><button type="button" class="btn btn-inform" name="search" >issue</button></a>
		</th>
		</form>
      </tr>
    </thead>
	...
	<table class="table table-bordered">
      ...
      <tr>
        ...
        <td style="text-align:center;" ><a href="add_bucket.php?b_id=<?php echo $b->book_id; ?>" ><button type="button" class="btn btn-success">+</button></a></td>
